<?php 
      ...
      echo "<h3 class='text-center mt-3'>Products list</h3>";
           ...
           $json = file_get_contents($url);
            ...
            foreach ($json as $product) {
                  $product = (array)$product;
                   if($product['Stock_50']>0){
                        echo '<li class="list-group-item">'. $product['ItemDescription']  .' ( ' . $product['SKU'] . ')<span class="badge badge-primary badge-pill float-right">'. $product['Stock_50'] .'</span></li>';
                   }
            }
      }
